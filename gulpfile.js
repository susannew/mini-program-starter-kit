...
gulp.task('copy-weapp', () => config.weappCopy())
...
gulp.task('watch', done => {
  ...
  gulp.watch(config.srcFiles.weapp, gulp.series(['copy-weapp']))
...
gulp.task(
  'dev',
  gulp.series(['clean', 'buildJsTask', 'lessCompile', 'copy-file', 'copy-wxml', 'copy-weapp', 'watch']),
)
